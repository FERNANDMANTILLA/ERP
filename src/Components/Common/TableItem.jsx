...
const TableItem = ({empresa,index}) => {
  ...
  return (
    ...
    <span className='col-8 bg-gray d-flex justify-content-between border-bottom border-right border-black modal-dialog-centered'>{empresa.razon_social}<Link to= {`/complete/${empresa.id}`} className='btn btn-danger rounded-1 m-1 p-1'>COMPLETAR</Link></span>
    </li>
  )
}
